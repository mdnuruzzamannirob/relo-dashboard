...
const Profile = () => {
  ...
  // API mutations
  const [profileImageMutation, { isLoading: isUploadingImage }] =
    useProfileImageMutation();
  const [profileUpdateMutation, { isLoading: isUpdatingProfile }] =
    useProfileUpdateMutation();
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleProfileSubmit}>
          <div className="border-brand-100 bg-white rounded-xl border p-6">
            <h2 className="text-primary mb-6 text-base font-semibold">
              Profile Information
            </h2>
        ...
        <form onSubmit={handleSubmit(handlePasswordSubmit)}>
          ...
          <div className="mt-4 flex gap-3">
            <Button
              ...
              className="h-11"
              disabled={
                !hasAnyPasswordInput || isSubmitting || isChangingPassword
              }
            >
